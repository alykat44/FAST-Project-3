                        ...
                        <div class="row">
                            <div class="column-1-6">
                                <div className="nav-item dropdown dropright" id="nav-anchors">
                                    <a className="nav-link dropdown-toggle" id="nav-home" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                        Customer
              </a>
                                    <div className="dropdown-menu" id="login-menu">
                                        <form className="px-4 py-3">
                                            <div className="form-group">
                                                <label htmlFor="userNameDropDownForm" id="label-user-form">User Name</label>
                                                <input type="text" className="form-control" id="userNameField" placeholder="user name" />
                                            </div>
                                            <div className="form-group">
                                                <label htmlFor="passwordDropDownForm" id="label-user-form">Password</label>
                                                <input type="password" className="form-control" id="passwordField" placeholder="Password" />
                                            </div>
                                            <div className="form-check">
                                                <input type="checkbox" className="form-check-input" id="dropdownCheck" />
                                                <label className="form-check-label" htmlFor="dropdownCheck" id="label-user-form">
                                                    Remember me
                    </label>
                                            </div>
                                            <button type="submit" className="btn btn-primary" id="user-btn">Sign in</button>
                                        </form>
